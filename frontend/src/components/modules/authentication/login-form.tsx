    ...
    <Card className="border-2 rounded-3xl shadow-xl overflow-hidden bg-card/50 backdrop-blur-sm" {...props}>
      <CardHeader className="space-y-1 pb-6">
        <CardTitle className="text-3xl font-black tracking-tight">
          Login to <span className="text-primary italic">FoodHub</span>
        </CardTitle>
      ...
      <CardFooter className="flex flex-col gap-4 pb-8">
        <Button form="login-form" type="submit" className="w-full h-12 rounded-xl font-black text-lg bg-primary text-black hover:bg-primary/90 shadow-lg shadow-primary/20 transition-all active:scale-[0.98]">
          Login
        </Button>
        <div className="relative w-full py-2">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-card px-2 text-muted-foreground font-bold italic">Or continue with</span>
          </div>
        </div>
        <Button
        ...
        <p className="text-sm text-center text-muted-foreground mt-2">
          ...
          <Link href="/register" className="text-primary font-black hover:underline italic">
            Sign up
          </Link>
        </p>
      </CardFooter>
